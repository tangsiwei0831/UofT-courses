...
(check-equal? (eva '((λ (y) (λ (y) (λ (y) y))) 369)) '(λ (y) (λ (y) y)))
(check-equal? (eva '(((((λ (x) (λ (y) (λ (x) (λ (z) z)))) 111) 222) 333) 444)) 444)
(check-equal? (eva '((λ (x) ((λ (y) ((λ (z) z) "abc")) "qwe")) "dfg")) "abc")

(check-equal? (replace '(λ (x) x) 369) 369)
(check-equal? (replace '(λ (x) "Hello") 369) "Hello")
(check-equal? (replace '(λ (x) ((λ (y) y) "why")) 369) '((λ (y) y) "why"))