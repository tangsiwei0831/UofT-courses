...
; Implement tails, which takes a racket value representing an expression
...
(module+ test
  ...
  (check-equal? (tails '(and "hi" (g 3 4))) (list '(g 3 4)))
  (check-equal? (tails '(g 3 4)) (list '(g 3 4)))
)

(define (tails e)
  (match e
    ((list if ---  a b) (append (tails a) (tails b)))
    ((list 'and --- c) (tails c))
    (--- (list ---))
  ))
